...
| `PAYMENTS-06` | Payments backend | `PENDIENTE` | `PAYMENTS-05` | `TASK_PAYMENTS_06_HARDENING.md` | `backend/src/modules/payments` |
| `PAYMENTS-07` | Payments mobile/backend | `PENDIENTE` | `PAYMENTS-06` | `TASK_PAYMENTS_07_FRONTEND_DOCUMENTATION.md` | `mobile/src`, `backend/src/modules/payments` |
