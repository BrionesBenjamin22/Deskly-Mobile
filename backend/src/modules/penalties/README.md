...
La vigencia termina en `activeUntil`, un mes despues de `registeredAt`. El bloqueo temporal se guarda en `User.blockedUntil`, manteniendo `User.active` para bajas administrativas.
